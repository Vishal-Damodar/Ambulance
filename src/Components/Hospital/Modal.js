...
export default function ScrollDialog(props) {
  ...
  async function sendChat() {
    ...
    const { data, error } = await supabase
      ...
      .insert([
        {
          phnum: props.data.phnum,
          hospital: Cookies.get("emailH"),
          text: msg,
          isitme: 0,
        },
      ])
        ...
        <DialogContent dividers={scroll === "paper"}>
          ...
          >
            <p style={{ textAlign: "center", fontStyle: "italic" }}>
              {" "}
              “Hide yourself in God, so when a man wants to find you he will
              have to go there first.” “It's a great honor,” said Fedyor
            </p>
            <div
              style={{
                display: "flex",
            ...
            >
              <a href={`tel:+91${props.data.phnum}`}>
                <button
                  type="button"
          ...
          <div style={{ width: "100%" }}>
            ...
            <div class="relative">
              ...
              <input
                ...
                placeholder="We will send the ambulance soon..."
                required
                value={msg}
                onChange={(e) => {
